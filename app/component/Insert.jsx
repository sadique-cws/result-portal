      ...
      <div className='flex flex-col gap-7'>
        ...
        <div className='flex gap-4 justify-evenly'>
          ...
          <div className='flex flex-col'>
            ...
            <input type="text" id='schoolName' placeholder='Enter Your SchoolName' className='h-10 placeholder:text-sm outline-none border-2 border-gray-300 px-1 rounded-md' />
          </div>
        </div>
